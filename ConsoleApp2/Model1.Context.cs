...
namespace ConsoleApp2
{
    ...
    public partial class AdventureWorks2017Entities : DbContext
    {
        ...
        [DbFunction("AdventureWorks2017Entities", "ufnGetContactInformation")]
        public virtual IQueryable<ufnGetContactInformation_Result> ufnGetContactInformation(Nullable<int> personID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetContactInformation_Result>("[AdventureWorks2017Entities].[ufnGetContactInformation](@PersonID)", personIDParameter);
        }
